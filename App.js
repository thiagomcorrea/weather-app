  ...
  return (
    <ThemeContext.Provider value = {themeHook}>
      <View style={styles.container}>
        ...
        <Feather style={{marginTop: 50}} name='cloud' size={40} color="orange" />
        ...
        <Text style={styles.localizationText}>{locationName}, {currentHour}</Text>
        ...
        <View style={styles.info}>
          ...
          <View style={styles.addtionalInfo}>
            ...
            <InfoCard title={'Temp. Min'} variable={temperatureMin+ 'º'} ></InfoCard>
            <InfoCard title={'Temp. Max'} variable={temperatureMax + 'º'} ></InfoCard>
          </View>
        </View>
